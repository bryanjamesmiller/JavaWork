...
public class QueueTester {
	...
	private class Purchase2 {
		private int numShares;
		private int price;

		Purchase2(int numShares, int price) {
    ...
    public static void main(String[] args) {
        LLQueue<Purchase2> myQueue = null;
        String commandChar, commandString, item;
        Purchase2 myTestPurchaseObject = new Purchase2(3, 5);
        int type;
        ...
        while(true) {
            ...
            try {
                if (commandChar.equalsIgnoreCase("q"))
                    ...
                    // insert
                    item = in.nextLine();
                    if (myQueue.insert(myTestPurchaseObject) == false)
                    ...
                    if (myQueue.isEmpty())
                    	...
                    	myTestPurchaseObject = myQueue.remove();
                        System.out.println("Removed: " + myTestPurchaseObject);
                    }
                    ...
                    if (myQueue.isEmpty())
                    	...
                    	myTestPurchaseObject = myQueue.peek();
                        System.out.println("Peeked at: " + myTestPurchaseObject);
                    }
                } else
